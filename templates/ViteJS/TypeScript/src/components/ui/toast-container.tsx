...
type ToasterProps = {
  type?: "neutral" | "iconic" | "colored";
} & React.ComponentProps<typeof Toaster>;

const ToastContainer = ({ type = "iconic", ...props }: ToasterProps) => {
  ...
  return (
    <Toaster
      ...
      toastOptions={{
        classNames: {
          toast: `group toast bg-background text-foreground font-sans gap-3 ${
          ...
          icon: "text-center text-foreground",
          success:
            type === "colored"
